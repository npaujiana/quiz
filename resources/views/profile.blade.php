...
sandhikagalih
  <head>
    ...
    <title>My Portfolio | Nur Paujiana</title>
  </head>
  <body id="home">
    <!-- Navbar -->
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary shadow-sm fixed-top">
      <div class="container">
        <a class="navbar-brand" href="#">Nur Paujiana</a>
    ...
    <section class="jumbotron text-center">
      <img src="../image/pauji.jpeg" alt="Nur Paujiana" width="200" class="rounded-circle img-thumbnail" />
      <h1 class="display-4">Nur Paujiana</h1>
      <p class="lead">Student | Back End Developer</p>
        ...
        <div class="row justify-content-center">
          <div class="col-md-4 mb-3">
            <div class="card" style="width: 18rem;">
              <img src="../image/project (1).jpg" class="card-img-top" alt="Project 1" />
              <div class="card-body">
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
              </div>
            </div>
          </div>
          <div class="col-md-4 mb-3" data-aos-delay="500">
            <div class="card" style="width: 18rem;">
              <img src="../image/project (1).jpg" class="card-img-top" alt="Project 2" />
              <div class="card-body">
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
              </div>
            </div>
          ...
          <div class="col-md-4 mb-3">
            <div class="card" style="width: 18rem;">
              <img src="../image/project (1).jpg" class="card-img-top" alt="Project 3" />
              <div class="card-body">
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
              </div>
            </div>
          ...
          <div class="col-md-4 mb-3" data-aos-delay="500">
            <div class="card" style="width: 18rem;">
              <img src="../image/project (1).jpg" class="card-img-top" alt="Project 4" />
              <div class="card-body">
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
              </div>
            </div>
          ...
          <div class="col-md-4 mb-3">
            <div class="card" style="width: 18rem;">
              <img src="../image/project (1).jpg" class="card-img-top" alt="Project 5" />
              <div class="card-body">
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
              </div>
            </div>
    ...
    <footer class="bg-primary text-white text-center pb-5">
      <p>Created with <i class="bi bi-heart-fill text-danger"></i> by <a href="https://www.instagram.com/nur_paujiana/" class="text-white fw-bold">Nur Paujiana</a></p>
    </footer>
    <!-- Akhir Footer -->
